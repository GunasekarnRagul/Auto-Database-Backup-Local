...
class NextcloudFileDeleteWizard(models.TransientModel):
    _name = 'nextcloud.file.delete.wizard'
    _description = 'Confirm Deletion of Tracked Folder (AWS S3)'

    folder_id = fields.Many2one('nextcloud.file', string='Folder', required=True)
