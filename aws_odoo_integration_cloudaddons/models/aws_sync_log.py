...
class NextcloudSyncLog(models.Model):
    _name = 'nextcloud.sync.log'
    _description = 'AWS S3 Sync Log'
    ...
    def create_log(self, vals):
        ...
        try:
            ...
            return self.env['nextcloud.sync.log']
    ...
    def log_operation(self, config, file_name, operation, state='success',
                      ...
                      nextcloud_file_id=False, file_size=0, duration=0,
                      user_id=False):
