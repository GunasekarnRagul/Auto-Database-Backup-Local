# -*- coding: utf-8 -*-
{
    ...
    'assets': {
        'web.assets_backend': [
            'auto_database_backup/static/src/css/backup_dashboard.css',
            'auto_database_backup/static/src/css/upgrade_page.css',
            'auto_database_backup/static/src/xml/upgrade_page.xml',
            'auto_database_backup/static/src/js/upgrade_page.js',
        ],
    },
}
