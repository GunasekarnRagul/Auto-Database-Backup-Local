...
class DropboxFileDeleteWizard(models.TransientModel):
    _name = 'one.drive.file.delete.wizard'
    _description = 'Confirm Deletion of Tracked Folder'

    folder_id = fields.Many2one('one.drive.file', string='Folder', required=True)
