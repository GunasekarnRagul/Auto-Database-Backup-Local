...
class DropboxFolderWizard(models.TransientModel):
    _name = 'one.drive.folder.wizard'
    _description = 'Dropbox Folder Bulk Add Wizard'
    ...
    def action_fetch_folders(self):
        """Fetch top-level folders from the connected Dropbox."""
        self.ensure_one()
        ...
        if not access_token:
            return {
                ...
                'params': {
                    ...
                    'message': _('Could not connect to Dropbox. Please check your credentials.'),
                    'sticky': False,
                }
            }
        ...
        # Use Dropbox list_folder to get top-level folders
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                _logger.warning("Dropbox API error during folder fetch: %s", response.text)
...
class DropboxFolderWizardLine(models.TransientModel):
    _name = 'one.drive.folder.wizard.line'
    _description = 'Dropbox Folder Bulk Add Wizard Line'
