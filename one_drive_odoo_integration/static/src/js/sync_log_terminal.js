...
SyncLogTerminal.template = "one_drive_odoo_integration.SyncLogTerminal";

registry.category("actions").add("one_drive_odoo_integration.sync_log_terminal", SyncLogTerminal);
