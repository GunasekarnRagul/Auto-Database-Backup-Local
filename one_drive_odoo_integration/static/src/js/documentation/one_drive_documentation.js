...
GoogleDriveDocumentation.template = "one_drive_odoo_integration.Documentation";

registry.category("actions").add("one_drive_odoo_integration.documentation", GoogleDriveDocumentation);
