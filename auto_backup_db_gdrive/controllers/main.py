...
class GoogleBackupController(http.Controller):
    ...
    def google_backup_oauth2callback(self, **kw):
        ...
        # Reconstruct redirect URI (must match the one used in action_gdrive_authenticate)
        ...
        if response.status_code == 200:
            ...
            if refresh_token:
                ICP.set_param('auto_backup_db_gdrive.refresh_token', refresh_token)
