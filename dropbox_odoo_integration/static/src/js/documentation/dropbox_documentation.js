...
GoogleDriveDocumentation.template = "dropbox_odoo_integration.Documentation";

registry.category("actions").add("dropbox_odoo_integration.documentation", GoogleDriveDocumentation);
